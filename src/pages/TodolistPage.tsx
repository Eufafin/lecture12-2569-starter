...
// import { FooterProps } from "../libs/Footer";
          ...
          <main className="flex-grow-1 p-4">
            <div className="container">
              ...
              */}
              ...
              // 📋 src/pages/TodolistPage.tsx
                {
                  tasks.map((task) => (
                    <TaskCard
                      key={task.id} // should have and should be some number doesnt duplicate
                      id={task.id}
                      title={task.title}
              ...
              <TaskCard id="1" title="wat" description="UIAA" isDone ></TaskCard>
            </div>
          </main>
          {/* ══ [ขั้นที่ 3] แยก Component "Footer" + ส่ง props ════════
               <Footer year="2026" fullName="..." studentId="..." />
          */}
          <Footer year="2026" fullName="Kittipat Namjak" studentId={680610654} ></Footer>
        </div>
      </div>
    </div>
  );
